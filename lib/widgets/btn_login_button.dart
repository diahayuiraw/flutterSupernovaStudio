...
class btnLoginButton extends StatelessWidget {
  btnLoginButton({Key key, this.onBtnLoginPressed, AnimationController btnLoginButtonAnimationController}) :
    scale = Interpolation<double>(keyframes: [
      ...
      parent: btnLoginButtonAnimationController,
  ...
  super(key: key);
  VoidCallback onBtnLoginPressed;
    ...
    return FadeTransition(
      ...
      child: ScaleTransition(
        ...
        child: FlatButton.icon(
          ...
          onPressed: this.onBtnLoginPressed,
