...
class star6Image extends StatelessWidget {
  star6Image({Key key, AnimationController star6ImageAnimationController}) :
    scale = Interpolation<double>(keyframes: [
      ...
      parent: star6ImageAnimationController,
      curve: Interval(0, 0.69, curve: Cubic(0.215, 0.61, 0.355, 1)),
    )),
    opacity = Interpolation<double>(keyframes: [
      Keyframe<double>(fraction: 0, value: 1),
      Keyframe<double>(fraction: 0, value: 0),
      Keyframe<double>(fraction: 0.917, value: 1),
      Keyframe<double>(fraction: 1, value: 1),
    ]).animate(CurvedAnimation(
      parent: star6ImageAnimationController,
      curve: Interval(0.172, 0.828, curve: Cubic(0.215, 0.61, 0.355, 1)),
    )),
  super(key: key);
