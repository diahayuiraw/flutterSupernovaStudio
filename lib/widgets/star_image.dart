...
class starImage extends StatelessWidget {
  starImage({Key key, AnimationController starImageAnimationController}) :
    scale = Interpolation<double>(keyframes: [
      ...
      parent: starImageAnimationController,
      curve: Interval(0, 0.606, curve: Cubic(0.215, 0.61, 0.355, 1)),
    )),
    opacity = Interpolation<double>(keyframes: [
      Keyframe<double>(fraction: 0, value: 1),
      Keyframe<double>(fraction: 0.001, value: 0),
      Keyframe<double>(fraction: 0.818, value: 1),
      Keyframe<double>(fraction: 1, value: 1),
    ]).animate(CurvedAnimation(
      parent: starImageAnimationController,
